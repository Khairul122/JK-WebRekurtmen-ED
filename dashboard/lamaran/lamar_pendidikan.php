        ...
        <form action='' method='POST' enctype="multipart/form-data">
            ...
            foreach ($one as $data) { ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pendidikan_terkakhir" name='pendidikan_terkakhir'>
                </div>
            ...
            <?php } ?>
            <input type='submit' name='insert_data_pendidikan' value='Next' class='btn btn-sm btn-warning'>
        </form>
    </div>
</div>