...
<?php
// $id_profile = $_GET['id_profile']; // Ambil id_profile dari parameter URL

// // Gantilah nama field sesuai dengan struktur tabel tbl_profile Anda
// $query_select_profile = "SELECT * FROM tbl_profile WHERE id_profile = '$id_profile'";
...
//   $id_profile_baru = mysqli_insert_id(Connect());
//   $id_profile_from_url = isset($_GET['id_profile']) ? $_GET['id_profile'] : null;
//   $_SESSION['id_profile'] = $id_profile_from_url;
?>
